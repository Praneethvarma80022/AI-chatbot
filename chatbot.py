...
def main():
    ...
    if choice == 'Home':
    ...
    elif choice == 'Converstation History':
        ...
        st.write("The chatbot interface is simple, it takes user input and returns the response from the chatbot after pressing the enter key.")
